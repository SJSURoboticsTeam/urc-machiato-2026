...
class GazeboIntegration:
    ...
    AVAILABLE_WORLDS = {
        'urc_desert_terrain': GazeboWorld(
            ...
            world_file=Path('src/simulation/gazebo_simulation/worlds/urc_desert_terrain.world'),
        ...
        'urc_obstacles': GazeboWorld(
            name='urc_obstacles',
            world_file=Path('src/simulation/gazebo_simulation/worlds/urc_obstacles.world'),
        ...
        'gps_denied_area': GazeboWorld(
            ...
            world_file=Path('src/simulation/gazebo_simulation/worlds/gps_denied_area.world'),
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'gazebo_running': self.gazebo_process is not None and self.gazebo_process.poll() is None,
            'rviz_running': self.rviz_process is not None and self.rviz_process.poll() is None,
