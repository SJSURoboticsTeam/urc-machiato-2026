...
import { Shield, Navigation, Eye, Zap, Radio, CheckCircle2, XCircle, Loader2, AlertTriangle, BarChart3 } from 'lucide-react';
...
export const TestingTab = () => {
  const [viewMode, setViewMode] = useState('integrated'); // 'integrated' or 'legacy'

  // Legacy component view
  const LegacyTestingView = () => {
  const {
    currentState,
    systemStatus,
    setRunningTests
