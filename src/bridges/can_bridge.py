...
class CANBridge:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.sensor_data: Dict[str, Dict] = {"imu": {}, "encoders": {}, "battery": {}, "system": {}}
    ...
    def _decode_velocity_feedback(self, frame: bytes) -> Optional[Twist]:
        ...
        try:
            ...
            if msg_id not in (RECEIVE_IDS["SET_VELOCITIES_RESPONSE"], RECEIVE_IDS["RETURN_ESTIMATED_CHASSIS_VELOCITIES"]):
                return None
    ...
    async def send_message(self, message: BridgeMessage) -> bool:
        ...
        try:
            if message.message_type == "velocity_command":
                ...
                return await self.send_message(BridgeMessage(message_type="velocity_command", data={"twist": twist}))
