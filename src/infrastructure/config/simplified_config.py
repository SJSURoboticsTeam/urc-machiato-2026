...
class RoverConfig:
    ...
    def _load_defaults(self):
        ...
        self._config = {
            ...
            "ros2": {"namespace": "urc_rover", "node_name": "rover_node"},
            "hardware": {
                "max_motor_speed": 100,
                "camera_device": "/dev/video0",
                "motor_port": "/dev/ttyUSB0",
            },
            "dashboard": {"port": 5173, "host": "localhost"},
            "simulation": {
                "world_file": "urc_mars_yard.world",
                "real_time_factor": 1.0,
            },
            "logging": {"level": "INFO", "file": "output/logs/rover.log"},
            "missions": {"timeout_seconds": 300, "waypoint_tolerance": 0.5},
        }
