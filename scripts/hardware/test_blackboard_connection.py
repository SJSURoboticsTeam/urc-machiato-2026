...
class BlackboardTester(Node):
    ...
    def test_service_available(self):
        ...
        print(
            f"Get service (/blackboard/get_value): {'✓ AVAILABLE' if get_available else '✗ NOT AVAILABLE'}"
        )
        print(
            f"Set service (/blackboard/set_value): {'✓ AVAILABLE' if set_available else '✗ NOT AVAILABLE'}"
        )
        print()
        ...
        if not (get_available and set_available):
            ...
            print("This means:")
            print(
                "  - hardware_interface CAN write to blackboard (Option 1 code is present)"
            )
...
def main():
    ...
    try:
        ...
        if services_available:
            ...
            print(
                "  ✗ Blackboard service (/blackboard/get_value, /blackboard/set_value)"
            )
            print()
