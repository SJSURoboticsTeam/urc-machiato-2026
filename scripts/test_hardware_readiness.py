...
class HardwareTestSuite:
    ...
    def test_state_manager_for_hardware(self) -> bool:
        ...
        try:
            ...
            self.record(
                "Boot state defined", state == SystemState.BOOT, f"State: {state.value}"
            )
    ...
    def test_component_registry_for_hardware(self) -> bool:
        ...
        try:
            ...
            self.record(
                "Registry instantiation", True, "SimplifiedComponentRegistry created"
            )
            ...
            self.record(
                "Motor controllers registered",
                len(registry._components) == 3,
            ...
            self.record(
                "Sensor readers registered",
                len(registry._components) == 6,
    ...
    def test_communication_patterns(self) -> bool:
        ...
        try:
            ...
            self.record(
                "Message latency", latency < 0.1, f"Latency: {latency*1000:.2f}ms"
            )
    ...
    def test_mission_execution_framework(self) -> bool:
        ...
        try:
            ...
            self.record(
                "Mission creation", mission is not None, f"Mission: {mission.name}"
            )
            ...
            self.record(
                "Mission start",
                started and mission.state == "running",
            ...
            self.record(
                "Mission abort",
                aborted and mission2.state == "aborted",
