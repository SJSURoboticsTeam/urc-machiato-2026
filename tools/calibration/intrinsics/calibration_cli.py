...
def cmd_calibrate(args):
    ...
    try:
        ...
        camera_config = CameraConfig(
            name=camera_name, camera_index=camera_id, resolution=resolution
        )
...
Examples:
  ...
  python3 calibration_cli.py --test
    ...
    calibrate_parser.add_argument(
        "--count", type=int, default=50, help="Target number of images"
    )
    ...
    calibrate_parser.add_argument(
        "--resolution", help="Custom resolution (WIDTHxHEIGHT)"
    )
