...
class SystemWorkflowTest:
  ...
  waypoints: ['test_waypoint']
    ...
    def test_sensor_data_flow(self):
        ...
        # Check for IMU data
        success, stdout, stderr = self.run_command("timeout 5 ros2 topic echo /imu --once 2>/dev/null | wc -l", timeout=10)
    ...
    def run_command(self, cmd, timeout=30):
        ...
        try:
            env = os.environ.copy()
            env['PYTHONPATH'] = '/home/durian/urc-machiato-2026/install/autonomy_utilities/lib/python3.12/site-packages:' + env.get('PYTHONPATH', '')
