...
- **Inputs:**
  ...
  - GNSS coordinates provided for the vicinity of two posts, which will be marked with 3-sided visual markers displaying black and white ArUco tags (from the 4x4_50 tag library, with 20x20 cm faces, positioned 0.5-1.5m off the ground).
