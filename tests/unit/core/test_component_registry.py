...
class TestComponentRegistry:
    ...
    def test_component_registration(self, component_registry, mock_component):
        ...
        result = component_registry.register_component(
            "test_component", mock_component, ["navigation", "communication"]
        )
        ...
        assert component_registry.dependencies["test_component"] == [
            "navigation",
            "communication",
        ]
    ...
    def test_component_with_dependencies_registration(self, component_registry):
        ...
        component_registry.register_component(
            "mission_executor", mission_component, ["navigation", "communication"]
        )

        # Verify dependency graph
        assert component_registry.dependencies["mission_executor"] == [
            "navigation",
            "communication",
        ]
    ...
    def test_dependency_resolution(self, component_registry):
        ...
        component_registry.register_component(
            "mission", mission, ["navigation", "communication"]
        )
    ...
    def test_component_health_monitoring(self, component_registry, mock_component):
        ...
        # Run health check
        health = asyncio.run(
            component_registry.check_component_health("test_component")
        )
    ...
    def test_concurrent_access_handling(self, component_registry):
        ...
        def concurrent_operation(operation_id: int):
            ...
            # Register component
            component_registry.register_component(
                f"concurrent_{operation_id}", component
            )

            # Start component
            result = asyncio.run(
                component_registry.start_component(f"concurrent_{operation_id}")
            )
    ...
    def test_component_filtering(self, component_registry):
        ...
        # Filter by status
        started_components = component_registry.get_components_by_status(
    ...
    def test_registry_serialization(self, component_registry, mock_component):
        ...
        component_registry.register_component(
            "test_component", mock_component, ["dep1", "dep2"]
        )
...
class TestComponentRegistryIntegration:
    ...
    def test_registry_high_availability_setup(self):
        ...
        registry.register_component(
            "navigation_backup", backup_nav, tags={"backup": True}
        )
