...
class TestMissionExecutor:
    ...
    def test_initialization(self, mission_executor, mock_node):
        ...
        mock_node.get_logger.return_value.info.assert_called_with("Mission Executor ready")
    ...
    def test_start_mission(self, mission_executor):
        ...
        mission_executor.node.get_logger.return_value.info.assert_called_with("Mission started")
    ...
    def test_stop_mission(self, mission_executor):
        ...
        mission_executor.node.get_logger.return_value.info.assert_called_with("Mission stopped")
    ...
    def test_pause_mission(self, mission_executor):
        ...
        mission_executor.node.get_logger.return_value.info.assert_called_with("Mission paused")
...
class TestMissionExecutorIntegration:
    ...
    @patch('mission_executor.rclpy.init')
    @patch('mission_executor.rclpy.spin')
    @patch('mission_executor.rclpy.shutdown')
    def test_main_function(self, mock_shutdown, mock_spin, mock_init):
        """Test main function execution."""
        from mission_executor import main
    ...
    def test_full_command_workflow(self, mission_executor):
        ...
        published_messages = [
            call[0][0].data for call in mission_executor.status_pub.publish.call_args_list
        ]
