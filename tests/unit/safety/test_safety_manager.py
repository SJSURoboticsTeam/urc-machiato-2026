...
class TestSafetyManager(unittest.TestCase):
    ...
    def test_software_estop_recovery(self):
        ...
        behavior = self.safety_manager.determine_recovery(
            SafetyTriggerType.SOFTWARE_ESTOP, None
        )
    ...
    def test_safestop_recovery(self):
        ...
        behavior = self.safety_manager.determine_recovery(
            SafetyTriggerType.SAFESTOP_REQUEST, None
        )
    ...
    def test_proximity_violation_recovery(self):
        ...
        behavior = self.safety_manager.determine_recovery(
            SafetyTriggerType.PROXIMITY_VIOLATION, None
        )
    ...
    def test_trigger_safety_event(self, mock_time):
        ...
        self.assertIn(
            SafetyTriggerType.EMERGENCY_STOP, self.safety_manager._active_triggers
        )
    ...
    def test_clear_trigger(self):
        ...
        # Add a trigger
        self.safety_manager.trigger_safety(
            SafetyTriggerType.EMERGENCY_STOP, SafetySeverity.EMERGENCY, "Test", "test"
        )
    ...
    def test_clear_all_triggers(self):
        ...
        self.safety_manager.trigger_safety(
            SafetyTriggerType.EMERGENCY_STOP, SafetySeverity.EMERGENCY, "Test1", "test"
        )
        self.safety_manager.trigger_safety(
            SafetyTriggerType.SAFESTOP_REQUEST, SafetySeverity.WARNING, "Test2", "test"
        )
