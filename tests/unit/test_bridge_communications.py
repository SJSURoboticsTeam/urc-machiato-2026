...
class TestBridgeCommunications:
    ...
    def test_simple_bridge_command_routing(self, mock_config):
        ...
        result = asyncio.run(bridge.process_command({
    ...
    def test_simple_bridge_unknown_command(self, mock_config):
        ...
        result = asyncio.run(bridge._process_command({
    ...
    def test_bridge_concurrent_operations(self, mock_config):
        ...
        result1 = asyncio.run(bridge._process_command({"command": "cmd1", "data": "test1"}))
        result2 = asyncio.run(bridge._process_command({"command": "cmd2", "data": "test2"}))
