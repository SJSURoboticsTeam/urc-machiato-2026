...
class EnhancedAdvancedSystemsTest(unittest.TestCase):
    ...
    def _init_enhanced_systems(self):
        ...
        self.state_mgr_primary = get_state_manager("competition_bridge")
        self.state_mgr_secondary = get_state_manager("secondary_bridge")
        self.state_mgr_tertiary = get_state_manager("tertiary_bridge")
