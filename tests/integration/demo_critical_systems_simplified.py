...
def test_sensor_fusion():
    ...
    try:
        ...
        from autonomy.perception.sensor_fusion import SensorFusionManager, SensorType, SensorMeasurement, SensorStatus
...
def main():
    ...
    if passed == total:
        ...
        print("✅ Mock hardware server, sensor fusion, and motor control systems working correctly")
        return 0
    else:
