...
try:
    ...
    pytestmark = pytest.mark.skip(reason="launch_testing not available - install: sudo apt install ros-jazzy-launch-testing ros-jazzy-launch-testing-ros")
...
class TestLaunchFileIntegration:
    ...
    def test_bt_orchestrator_launch(self, launch_service):
        ...
        launch_file_path = PROJECT_ROOT / "tools" / "scripts" / "launch" / "integrated_system.launch.py"
