...
class StubSocketIOClient:
    ...
    def event(self, func_or_name=None):
        ...
        def decorator(func):
            event_name = func_or_name if isinstance(func_or_name, str) else func.__name__
...
class TestTeleopWebSocketBridge:
    ...
    async def test_bridge_creation(self):
        ...
        try:
            from bridges.teleop_websocket_bridge import TeleopWebSocketBridge, TeleopConfig
...
class TestIntegrationFlow:
    ...
    async def test_bidirectional_communication(self):
        ...
        await stub_client.trigger_event('driveCommands', {'xVel': 0.5, 'yVel': 0.0, 'rotVel': 0.0})
