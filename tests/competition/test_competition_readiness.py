...
class CompetitionReadinessTest(Node):
    ...
    def test_system_startup(self) -> Dict[str, Any]:
        ...
        result = {"passed": False, "details": [], "score": 0}
        ...
        try:
            ...
            found_nodes = [
                ...
                if any(node in rn for rn in running_nodes)
            ]
    ...
    def test_hardware_interface(self) -> Dict[str, Any]:
        ...
        try:
            ...
            found_topics = [
                topic for topic in topics_to_check if topic in available_topics
            ]
    ...
    def test_terrain_intelligence(self) -> Dict[str, Any]:
        ...
        terrain_topics = ["/terrain/traversability", "/terrain/classification"]
        ...
        try:
            ...
            available_topics = topics.stdout.strip().split("\n")
            found_topics = [
                topic for topic in terrain_topics if topic in available_topics
            ]

            result["details"].append(
                f"Found {len(found_topics)}/{len(terrain_topics)} terrain topics"
            )
    ...
    def test_competition_safety(self) -> Dict[str, Any]:
        ...
        # Check safety topics
        safety_topics = ["/safety/boundary_violation", "/safety/alert"]
        ...
        try:
            ...
            available_topics = topics.stdout.strip().split("\n")
            found_topics = [
                topic for topic in safety_topics if topic in available_topics
            ]

            result["details"].append(
                f"Found {len(found_topics)}/{len(safety_topics)} safety topics"
            )
