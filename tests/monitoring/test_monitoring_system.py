...
class TestMonitoringSystem:
    ...
    def test_safety_property_evaluation(self, safety_monitor):
        ...
        satisfied, details = safety_monitor.safety_properties[
            "battery_safety"
        ].evaluate(system_state)
    ...
    def test_geofence_safety(self, safety_monitor):
        ...
        system_state = {"mission_active": True, "boundary_violation": False}
    ...
    def test_monitoring_system_integration(
        self, qos_profiler, safety_monitor, competition_bridge
    ):
