...
struct SystemState_
{
  ...
  using _adaptive_enabled_type =
    bool;
  _adaptive_enabled_type adaptive_enabled;
  ...
  Type & set__adaptive_enabled(
    const bool & _arg)
  {
    this->adaptive_enabled = _arg;
    return *this;
  }
  ...
  bool operator==(const SystemState_ & other) const
  {
    ...
    if (this->adaptive_enabled != other.adaptive_enabled) {
      return false;
    }
