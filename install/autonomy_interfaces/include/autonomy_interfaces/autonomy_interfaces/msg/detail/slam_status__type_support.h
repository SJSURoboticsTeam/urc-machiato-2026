...
#ifndef AUTONOMY_INTERFACES__MSG__DETAIL__SLAM_STATUS__TYPE_SUPPORT_H_
#define AUTONOMY_INTERFACES__MSG__DETAIL__SLAM_STATUS__TYPE_SUPPORT_H_
...
#endif  // AUTONOMY_INTERFACES__MSG__DETAIL__SLAM_STATUS__TYPE_SUPPORT_H_
