  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x79, 0x2b, 0x8f, 0xcb, 0x77, 0x0d, 0x11, 0x4b,
      0x40, 0x11, 0xbd, 0xcf, 0x2f, 0xfb, 0xcf, 0x65,
      0x8d, 0x39, 0xad, 0xd8, 0xee, 0xad, 0xb8, 0x19,
      0x95, 0x7c, 0x59, 0xcc, 0x47, 0xd8, 0xd0, 0x7e,
    }};
  return &hash;
}
...
static char autonomy_interfaces__msg__SlamStatus__TYPE_NAME[] = "autonomy_interfaces/msg/SlamStatus";
...
static char autonomy_interfaces__msg__SlamStatus__FIELD_NAME__header[] = "header";
static char autonomy_interfaces__msg__SlamStatus__FIELD_NAME__state[] = "state";
static char autonomy_interfaces__msg__SlamStatus__FIELD_NAME__pose[] = "pose";
static char autonomy_interfaces__msg__SlamStatus__FIELD_NAME__local_map[] = "local_map";
static char autonomy_interfaces__msg__SlamStatus__FIELD_NAME__map_width[] = "map_width";
static char autonomy_interfaces__msg__SlamStatus__FIELD_NAME__map_height[] = "map_height";
static char autonomy_interfaces__msg__SlamStatus__FIELD_NAME__map_resolution[] = "map_resolution";
static char autonomy_interfaces__msg__SlamStatus__FIELD_NAME__loop_closure_confidence[] = "loop_closure_confidence";
static char autonomy_interfaces__msg__SlamStatus__FIELD_NAME__keyframes_tracked[] = "keyframes_tracked";
static char autonomy_interfaces__msg__SlamStatus__FIELD_NAME__landmarks_tracked[] = "landmarks_tracked";
static char autonomy_interfaces__msg__SlamStatus__FIELD_NAME__tracking_quality[] = "tracking_quality";
static char autonomy_interfaces__msg__SlamStatus__FIELD_NAME__loop_closure_detected[] = "loop_closure_detected";
static char autonomy_interfaces__msg__SlamStatus__FIELD_NAME__drift_estimate[] = "drift_estimate";

static rosidl_runtime_c__type_description__Field autonomy_interfaces__msg__SlamStatus__FIELDS[] = {
  {
    {autonomy_interfaces__msg__SlamStatus__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {autonomy_interfaces__msg__SlamStatus__FIELD_NAME__state, 5, 5},
    {
  ...
  {
    {autonomy_interfaces__msg__SlamStatus__FIELD_NAME__pose, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {autonomy_interfaces__msg__SlamStatus__FIELD_NAME__local_map, 9, 9},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {autonomy_interfaces__msg__SlamStatus__FIELD_NAME__map_width, 9, 9},
    {
  ...
  {
    {autonomy_interfaces__msg__SlamStatus__FIELD_NAME__map_height, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_INT32,
      0,
      0,
  ...
  {
    {autonomy_interfaces__msg__SlamStatus__FIELD_NAME__map_resolution, 14, 14},
    {
  ...
  {
    {autonomy_interfaces__msg__SlamStatus__FIELD_NAME__loop_closure_confidence, 23, 23},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  {
    {autonomy_interfaces__msg__SlamStatus__FIELD_NAME__keyframes_tracked, 17, 17},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_INT32,
      0,
      0,
  ...
  {
    {autonomy_interfaces__msg__SlamStatus__FIELD_NAME__landmarks_tracked, 17, 17},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_INT32,
      0,
      0,
  ...
  {
    {autonomy_interfaces__msg__SlamStatus__FIELD_NAME__tracking_quality, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  {
    {autonomy_interfaces__msg__SlamStatus__FIELD_NAME__loop_closure_detected, 21, 21},
    {
  ...
  {
    {autonomy_interfaces__msg__SlamStatus__FIELD_NAME__drift_estimate, 14, 14},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription autonomy_interfaces__msg__SlamStatus__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {autonomy_interfaces__msg__SlamStatus__TYPE_NAME, 34, 34},
      {autonomy_interfaces__msg__SlamStatus__FIELDS, 13, 13},
    },
    {autonomy_interfaces__msg__SlamStatus__REFERENCED_TYPE_DESCRIPTIONS, 9, 9},
  };
  if (!constructed) {
...
autonomy_interfaces__msg__SlamStatus__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *autonomy_interfaces__msg__SlamStatus__get_individual_type_description_source(NULL),
