...
// IWYU pragma: private, include "autonomy_interfaces/msg/system_state.hpp"
...
class Init_SystemState_active_adaptations
{
public:
  explicit Init_SystemState_active_adaptations(::autonomy_interfaces::msg::SystemState & msg)
  : msg_(msg)
  {}
  ::autonomy_interfaces::msg::SystemState active_adaptations(::autonomy_interfaces::msg::SystemState::_active_adaptations_type arg)
  {
...
class Init_SystemState_adaptive_enabled
{
public:
  explicit Init_SystemState_adaptive_enabled(::autonomy_interfaces::msg::SystemState & msg)
  : msg_(msg)
  {}
  Init_SystemState_active_adaptations adaptive_enabled(::autonomy_interfaces::msg::SystemState::_adaptive_enabled_type arg)
  {
    msg_.adaptive_enabled = std::move(arg);
    return Init_SystemState_active_adaptations(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_SystemState_adaptive_enabled state_reason(::autonomy_interfaces::msg::SystemState::_state_reason_type arg)
  {
    msg_.state_reason = std::move(arg);
    return Init_SystemState_adaptive_enabled(msg_);
  }
