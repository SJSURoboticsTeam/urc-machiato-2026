...
enum
{
  autonomy_interfaces__action__NavigateToPose_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  autonomy_interfaces__action__NavigateToPose_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/NavigateToPose in the package autonomy_interfaces.
typedef struct autonomy_interfaces__action__NavigateToPose_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  autonomy_interfaces__action__NavigateToPose_SendGoal_Request__Sequence request;
  autonomy_interfaces__action__NavigateToPose_SendGoal_Response__Sequence response;
} autonomy_interfaces__action__NavigateToPose_SendGoal_Event;

// Struct for a sequence of autonomy_interfaces__action__NavigateToPose_SendGoal_Event.
typedef struct autonomy_interfaces__action__NavigateToPose_SendGoal_Event__Sequence
{
...
enum
{
  autonomy_interfaces__action__NavigateToPose_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  autonomy_interfaces__action__NavigateToPose_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/NavigateToPose in the package autonomy_interfaces.
typedef struct autonomy_interfaces__action__NavigateToPose_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  autonomy_interfaces__action__NavigateToPose_GetResult_Request__Sequence request;
  autonomy_interfaces__action__NavigateToPose_GetResult_Response__Sequence response;
} autonomy_interfaces__action__NavigateToPose_GetResult_Event;

// Struct for a sequence of autonomy_interfaces__action__NavigateToPose_GetResult_Event.
typedef struct autonomy_interfaces__action__NavigateToPose_GetResult_Event__Sequence
{
