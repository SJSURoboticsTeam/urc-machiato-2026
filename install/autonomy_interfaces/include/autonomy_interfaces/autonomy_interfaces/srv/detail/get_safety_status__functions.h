...
#ifndef AUTONOMY_INTERFACES__SRV__DETAIL__GET_SAFETY_STATUS__FUNCTIONS_H_
#define AUTONOMY_INTERFACES__SRV__DETAIL__GET_SAFETY_STATUS__FUNCTIONS_H_
 ...
 * )) before or use
 * autonomy_interfaces__srv__GetSafetyStatus_Request__create()
 ...
 * calls
 * autonomy_interfaces__srv__GetSafetyStatus_Request__init().
...
/**
 * It calls
 * autonomy_interfaces__srv__GetSafetyStatus_Request__fini()
 ...
 * autonomy_interfaces__srv__GetSafetyStatus_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * autonomy_interfaces__srv__GetSafetyStatus_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * autonomy_interfaces__srv__GetSafetyStatus_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_autonomy_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * autonomy_interfaces__srv__GetSafetyStatus_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_autonomy_interfaces
...
/**
 * It calls
 * autonomy_interfaces__srv__GetSafetyStatus_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_autonomy_interfaces
...
/**
 * It allocates the memory for the array and calls
 * autonomy_interfaces__srv__GetSafetyStatus_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_autonomy_interfaces
...
/**
 * It calls
 * autonomy_interfaces__srv__GetSafetyStatus_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * autonomy_interfaces__srv__GetSafetyStatus_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_autonomy_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * autonomy_interfaces__srv__GetSafetyStatus_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_autonomy_interfaces
...
/**
 * It calls
 * autonomy_interfaces__srv__GetSafetyStatus_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_autonomy_interfaces
...
/**
 * It allocates the memory for the array and calls
 * autonomy_interfaces__srv__GetSafetyStatus_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_autonomy_interfaces
...
/**
 * It calls
 * autonomy_interfaces__srv__GetSafetyStatus_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AUTONOMY_INTERFACES__SRV__DETAIL__GET_SAFETY_STATUS__FUNCTIONS_H_
