...
// Member `request`
// Member `response`
#include "autonomy_interfaces/srv/validate_calibration.h"
// Member `request`
// Member `response`
// already included above
// #include "autonomy_interfaces/srv/detail/validate_calibration__rosidl_typesupport_introspection_c.h"
...
void autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  autonomy_interfaces__srv__ValidateCalibration_Event__init(message_memory);
}

void autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_fini_function(void * message_memory)
{
  autonomy_interfaces__srv__ValidateCalibration_Event__fini(message_memory);
}

size_t autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__size_function__ValidateCalibration_Event__request(
  const void * untyped_member)
{
  const autonomy_interfaces__srv__ValidateCalibration_Request__Sequence * member =
    (const autonomy_interfaces__srv__ValidateCalibration_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__get_const_function__ValidateCalibration_Event__request(
  const void * untyped_member, size_t index)
{
  const autonomy_interfaces__srv__ValidateCalibration_Request__Sequence * member =
    (const autonomy_interfaces__srv__ValidateCalibration_Request__Sequence *)(untyped_member);
...
void * autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__get_function__ValidateCalibration_Event__request(
  void * untyped_member, size_t index)
{
  autonomy_interfaces__srv__ValidateCalibration_Request__Sequence * member =
    (autonomy_interfaces__srv__ValidateCalibration_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__fetch_function__ValidateCalibration_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const autonomy_interfaces__srv__ValidateCalibration_Request * item =
    ((const autonomy_interfaces__srv__ValidateCalibration_Request *)
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__get_const_function__ValidateCalibration_Event__request(untyped_member, index));
  autonomy_interfaces__srv__ValidateCalibration_Request * value =
    (autonomy_interfaces__srv__ValidateCalibration_Request *)(untyped_value);
  *value = *item;
}

void autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__assign_function__ValidateCalibration_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  autonomy_interfaces__srv__ValidateCalibration_Request * item =
    ((autonomy_interfaces__srv__ValidateCalibration_Request *)
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__get_function__ValidateCalibration_Event__request(untyped_member, index));
  const autonomy_interfaces__srv__ValidateCalibration_Request * value =
    (const autonomy_interfaces__srv__ValidateCalibration_Request *)(untyped_value);
  *item = *value;
}

bool autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__resize_function__ValidateCalibration_Event__request(
  void * untyped_member, size_t size)
{
  autonomy_interfaces__srv__ValidateCalibration_Request__Sequence * member =
    (autonomy_interfaces__srv__ValidateCalibration_Request__Sequence *)(untyped_member);
  autonomy_interfaces__srv__ValidateCalibration_Request__Sequence__fini(member);
  return autonomy_interfaces__srv__ValidateCalibration_Request__Sequence__init(member, size);
}

size_t autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__size_function__ValidateCalibration_Event__response(
  const void * untyped_member)
{
  const autonomy_interfaces__srv__ValidateCalibration_Response__Sequence * member =
    (const autonomy_interfaces__srv__ValidateCalibration_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__get_const_function__ValidateCalibration_Event__response(
  const void * untyped_member, size_t index)
{
  const autonomy_interfaces__srv__ValidateCalibration_Response__Sequence * member =
    (const autonomy_interfaces__srv__ValidateCalibration_Response__Sequence *)(untyped_member);
...
void * autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__get_function__ValidateCalibration_Event__response(
  void * untyped_member, size_t index)
{
  autonomy_interfaces__srv__ValidateCalibration_Response__Sequence * member =
    (autonomy_interfaces__srv__ValidateCalibration_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__fetch_function__ValidateCalibration_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const autonomy_interfaces__srv__ValidateCalibration_Response * item =
    ((const autonomy_interfaces__srv__ValidateCalibration_Response *)
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__get_const_function__ValidateCalibration_Event__response(untyped_member, index));
  autonomy_interfaces__srv__ValidateCalibration_Response * value =
    (autonomy_interfaces__srv__ValidateCalibration_Response *)(untyped_value);
  *value = *item;
}

void autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__assign_function__ValidateCalibration_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  autonomy_interfaces__srv__ValidateCalibration_Response * item =
    ((autonomy_interfaces__srv__ValidateCalibration_Response *)
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__get_function__ValidateCalibration_Event__response(untyped_member, index));
  const autonomy_interfaces__srv__ValidateCalibration_Response * value =
    (const autonomy_interfaces__srv__ValidateCalibration_Response *)(untyped_value);
  *item = *value;
}

bool autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__resize_function__ValidateCalibration_Event__response(
  void * untyped_member, size_t size)
{
  autonomy_interfaces__srv__ValidateCalibration_Response__Sequence * member =
    (autonomy_interfaces__srv__ValidateCalibration_Response__Sequence *)(untyped_member);
  autonomy_interfaces__srv__ValidateCalibration_Response__Sequence__fini(member);
  return autonomy_interfaces__srv__ValidateCalibration_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autonomy_interfaces__srv__ValidateCalibration_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(autonomy_interfaces__srv__ValidateCalibration_Event, request),  // bytes offset in struct
    NULL,  // default value
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__size_function__ValidateCalibration_Event__request,  // size() function pointer
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__get_const_function__ValidateCalibration_Event__request,  // get_const(index) function pointer
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__get_function__ValidateCalibration_Event__request,  // get(index) function pointer
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__fetch_function__ValidateCalibration_Event__request,  // fetch(index, &value) function pointer
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__assign_function__ValidateCalibration_Event__request,  // assign(index, value) function pointer
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__resize_function__ValidateCalibration_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(autonomy_interfaces__srv__ValidateCalibration_Event, response),  // bytes offset in struct
    NULL,  // default value
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__size_function__ValidateCalibration_Event__response,  // size() function pointer
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__get_const_function__ValidateCalibration_Event__response,  // get_const(index) function pointer
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__get_function__ValidateCalibration_Event__response,  // get(index) function pointer
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__fetch_function__ValidateCalibration_Event__response,  // fetch(index, &value) function pointer
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__assign_function__ValidateCalibration_Event__response,  // assign(index, value) function pointer
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__resize_function__ValidateCalibration_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_message_members = {
  "autonomy_interfaces__srv",  // message namespace
  "ValidateCalibration_Event",  // message name
  3,  // number of fields
  sizeof(autonomy_interfaces__srv__ValidateCalibration_Event),
  false,  // has_any_key_member_
  autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_message_member_array,  // message members
  autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_message_type_support_handle = {
  0,
  &autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_autonomy_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autonomy_interfaces, srv, ValidateCalibration_Event)() {
  autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autonomy_interfaces, srv, ValidateCalibration_Request)();
  autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autonomy_interfaces, srv, ValidateCalibration_Response)();
  if (!autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_message_type_support_handle.typesupport_identifier) {
    autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t autonomy_interfaces__srv__detail__validate_calibration__rosidl_typesupport_introspection_c__ValidateCalibration_service_type_support_handle = {
  ...
  &autonomy_interfaces__srv__ValidateCalibration_Request__rosidl_typesupport_introspection_c__ValidateCalibration_Request_message_type_support_handle,
  &autonomy_interfaces__srv__ValidateCalibration_Response__rosidl_typesupport_introspection_c__ValidateCalibration_Response_message_type_support_handle,
  &autonomy_interfaces__srv__ValidateCalibration_Event__rosidl_typesupport_introspection_c__ValidateCalibration_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autonomy_interfaces, srv, ValidateCalibration_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autonomy_interfaces, srv, ValidateCalibration_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autonomy_interfaces, srv, ValidateCalibration_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_autonomy_interfaces
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autonomy_interfaces, srv, ValidateCalibration)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autonomy_interfaces, srv, ValidateCalibration_Event)()->data;
  }
