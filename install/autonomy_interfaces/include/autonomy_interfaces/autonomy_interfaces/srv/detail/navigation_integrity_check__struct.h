...
enum
{
  autonomy_interfaces__srv__NavigationIntegrityCheck_Event__request__MAX_SIZE = 1
};
// response
enum
{
  autonomy_interfaces__srv__NavigationIntegrityCheck_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/NavigationIntegrityCheck in the package autonomy_interfaces.
typedef struct autonomy_interfaces__srv__NavigationIntegrityCheck_Event
{
  service_msgs__msg__ServiceEventInfo info;
  autonomy_interfaces__srv__NavigationIntegrityCheck_Request__Sequence request;
  autonomy_interfaces__srv__NavigationIntegrityCheck_Response__Sequence response;
} autonomy_interfaces__srv__NavigationIntegrityCheck_Event;

// Struct for a sequence of autonomy_interfaces__srv__NavigationIntegrityCheck_Event.
typedef struct autonomy_interfaces__srv__NavigationIntegrityCheck_Event__Sequence
{
