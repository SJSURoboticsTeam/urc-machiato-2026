...
{
public:
  explicit Init_GetSystemState_Event_response(::autonomy_interfaces::srv::GetSystemState_Event & msg)
  : msg_(msg)
  {}
  ::autonomy_interfaces::srv::GetSystemState_Event response(::autonomy_interfaces::srv::GetSystemState_Event::_response_type arg)
  {
...
private:
  ::autonomy_interfaces::srv::GetSystemState_Event msg_;
};

class Init_GetSystemState_Event_request
{
public:
  explicit Init_GetSystemState_Event_request(::autonomy_interfaces::srv::GetSystemState_Event & msg)
  : msg_(msg)
  {}
  Init_GetSystemState_Event_response request(::autonomy_interfaces::srv::GetSystemState_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetSystemState_Event_request info(::autonomy_interfaces::srv::GetSystemState_Event::_info_type arg)
  {
...
template<>
inline
auto build<::autonomy_interfaces::srv::GetSystemState_Event>()
{
  return autonomy_interfaces::srv::builder::Init_GetSystemState_Event_info();
}
