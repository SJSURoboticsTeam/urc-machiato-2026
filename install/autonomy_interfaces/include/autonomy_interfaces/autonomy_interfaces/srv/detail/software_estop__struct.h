...
enum
{
  autonomy_interfaces__srv__SoftwareEstop_Event__request__MAX_SIZE = 1
};
// response
enum
{
  autonomy_interfaces__srv__SoftwareEstop_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SoftwareEstop in the package autonomy_interfaces.
typedef struct autonomy_interfaces__srv__SoftwareEstop_Event
{
  service_msgs__msg__ServiceEventInfo info;
  autonomy_interfaces__srv__SoftwareEstop_Request__Sequence request;
  autonomy_interfaces__srv__SoftwareEstop_Response__Sequence response;
} autonomy_interfaces__srv__SoftwareEstop_Event;

// Struct for a sequence of autonomy_interfaces__srv__SoftwareEstop_Event.
typedef struct autonomy_interfaces__srv__SoftwareEstop_Event__Sequence
{
