...
class Init_DetectAruco_Event_response
{
public:
  explicit Init_DetectAruco_Event_response(::autonomy_interfaces::srv::DetectAruco_Event & msg)
  : msg_(msg)
  {}
  ::autonomy_interfaces::srv::DetectAruco_Event response(::autonomy_interfaces::srv::DetectAruco_Event::_response_type arg)
  {
...
private:
  ::autonomy_interfaces::srv::DetectAruco_Event msg_;
};

class Init_DetectAruco_Event_request
{
public:
  explicit Init_DetectAruco_Event_request(::autonomy_interfaces::srv::DetectAruco_Event & msg)
  : msg_(msg)
  {}
  Init_DetectAruco_Event_response request(::autonomy_interfaces::srv::DetectAruco_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_DetectAruco_Event_response(msg_);
  }
...
class Init_DetectAruco_Event_info
{
public:
  Init_DetectAruco_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_DetectAruco_Event_request info(::autonomy_interfaces::srv::DetectAruco_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_DetectAruco_Event_request(msg_);
  }
...
template<>
inline
auto build<::autonomy_interfaces::srv::DetectAruco_Event>()
{
  return autonomy_interfaces::srv::builder::Init_DetectAruco_Event_info();
}
