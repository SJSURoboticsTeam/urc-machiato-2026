...
inline void to_flow_style_yaml(
  const NavigationIntegrityCheck_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const NavigationIntegrityCheck_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use autonomy_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const autonomy_interfaces::srv::NavigationIntegrityCheck_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  autonomy_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use autonomy_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const autonomy_interfaces::srv::NavigationIntegrityCheck_Event & msg)
{
  return autonomy_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<autonomy_interfaces::srv::NavigationIntegrityCheck_Event>()
{
  return "autonomy_interfaces::srv::NavigationIntegrityCheck_Event";
}

template<>
inline const char * name<autonomy_interfaces::srv::NavigationIntegrityCheck_Event>()
{
  return "autonomy_interfaces/srv/NavigationIntegrityCheck_Event";
}

template<>
struct has_fixed_size<autonomy_interfaces::srv::NavigationIntegrityCheck_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<autonomy_interfaces::srv::NavigationIntegrityCheck_Event>
  : std::integral_constant<bool, has_bounded_size<autonomy_interfaces::srv::NavigationIntegrityCheck_Request>::value && has_bounded_size<autonomy_interfaces::srv::NavigationIntegrityCheck_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<autonomy_interfaces::srv::NavigationIntegrityCheck_Event>
  : std::true_type {};
