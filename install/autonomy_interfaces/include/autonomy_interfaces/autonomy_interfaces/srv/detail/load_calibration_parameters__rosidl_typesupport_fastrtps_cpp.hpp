...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autonomy_interfaces
max_serialized_size_key_LoadCalibrationParameters_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autonomy_interfaces
max_serialized_size_key_LoadCalibrationParameters_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autonomy_interfaces
cdr_serialize(
  const autonomy_interfaces::srv::LoadCalibrationParameters_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autonomy_interfaces::srv::LoadCalibrationParameters_Event & ros_message);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autonomy_interfaces
max_serialized_size_LoadCalibrationParameters_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autonomy_interfaces
max_serialized_size_key_LoadCalibrationParameters_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autonomy_interfaces
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autonomy_interfaces, srv, LoadCalibrationParameters_Event)();
