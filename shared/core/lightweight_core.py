...
from shared.infrastructure.config import RoverConfig as SystemConfig, PerformanceConfig
...
class LightweightCore:
    ...
    def _register_loaders(self):
        ...
        def load_state_machine():
            from shared.core.simplified_state_manager import get_state_manager

            state_mgr = get_state_manager()
            return state_mgr.create_state_machine("lightweight_core", "idle")

        def load_behavior_tree():
            from shared.core.behavior_tree import URCBehaviorTree
        ...
        def load_api():
            from shared.core.simple_api import get_simple_api
