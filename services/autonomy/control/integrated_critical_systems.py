...
from autonomy_core.control.advanced_motor_controller import AdvancedMotorController
from autonomy_core.control.hardware_emergency_stop import (
    EmergencyStopConfig,
    cleanup_emergency_stop,
    initialize_emergency_stop,
)
from autonomy_core.perception.sensor_fusion import create_sensor_fusion_manager
from shared.core.graceful_degradation import (
    OperationMode,
    ...
    def _initialize_can_bridge(self):
        ...
        try:
            ...
            try:
                ...
                loop.create_task(self.can_bridge.connect())
            except RuntimeError:
                logger.debug("CAN connect deferred (no running asyncio loop)")
