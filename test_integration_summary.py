...
def test_service_discovery():
    ...
    for attempt in range(3):
        ...
        if len(found_services) == len(expected_services) and len(found_actions) == len(expected_actions):
            break  # All found
...
def test_led_system():
    ...
    success, _, _ = run_command("timeout 3 ros2 topic pub --once /hardware/led_command autonomy_interfaces/msg/LedCommand '{status_code: 1}' 2>/dev/null || true")
